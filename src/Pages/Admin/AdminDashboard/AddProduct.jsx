            ...
            <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden">
                ...
                <form onSubmit={addProduct} className="p-8 space-y-6">
                    ...
                    {product.thumbnail && (
                        <div>
                            ...
                            <img
                                ...
                                alt="preview"
                                className="w-full md:w-72 h-72 object-cover rounded-2xl border shadow-lg"
                            />
                        </div>
                    )}
                    ...
                    <div className="pt-4">
                        <button
                            type="submit"
                            className="w-full bg-green-600 hover:bg-green-700 text-white py-4 rounded-xl text-lg font-bold transition-all duration-300 hover:scale-[1.01] shadow-lg"
                        >
                            Add Product
                        </button>
                    </div>
