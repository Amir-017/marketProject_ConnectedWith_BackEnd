...
const WomensShoes = () => {
  const [womshoes, setWomShoes] = useState([]);
  ...
  const getFrag = () => {
    axios({
      method: "get",
      url: "https://e-commerce-nodejs-blush.vercel.app/products/category/womens-shoes",
    }).then((data) => setWomShoes(data.data.products));
  };
