...
const WomensJewellery = () => {
  ...
  const getWomensJewellery = () => {
    axios({
      method: "get",
       url: "https://e-commerce-nodejs-blush.vercel.app/products/category/womens-jewellery",
    }).then((data) => setWomensJewellery(data.data.products));
  };
