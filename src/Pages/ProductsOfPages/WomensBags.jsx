...
const WomensBags = () => {
  const [bagsWomen, setBagsWomen] = useState([]);
  ...
  const getWomensBags = () => {
    axios({
      method: "get",
      url: "https://e-commerce-nodejs-blush.vercel.app/products/category/womens-bags",
    }).then((data) => setBagsWomen(data.data.products));
  };
